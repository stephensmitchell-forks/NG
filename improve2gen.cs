...
namespace netgen
{
  ...
  {
	public Array<Element2d> oldels = new Array<Element2d>();
	public Array<Element2d> newels = new Array<Element2d>();
	public Array<INDEX_2> deledges = new Array<INDEX_2>();
	public Array<int> incelsonnode = new Array<int>();
	public Array<int> reused = new Array<int>();
	public int bonus;
	public int onp;
  }
